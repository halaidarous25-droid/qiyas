          ...
          {shownFits.length > 0 && (
            <div className="mt-5">
              ...
              <p className="mt-1 text-[11px] text-slate-400">
                نسبة المطابقة (المواءمة) رقم موحّد يعبّر عن مدى ملاءمة نتائج الطالب لأوزان معايير كل مهمة — وهو نفسه الظاهر في تقرير المهمة وتفاصيلها. وتُعرض الخبرة السابقة كشارة دون التأثير على الرقم.
              </p>
            </div>
          )}
          ...
          <details className="slis-glossary mt-6 rounded-lg border border-slate-200 bg-slate-50/70 p-4">
            ...
            <dl className="mt-2 grid gap-x-5 gap-y-2 sm:grid-cols-2">
              {[
                ...
                ["نسبة المطابقة (المواءمة)", "مصطلح واحد: مدى ملاءمة نتائج محاور الطالب لأوزان معايير المهمة. تُحسب بنفس الطريقة في تقرير الطالب وتقرير المهمة وتفاصيلها، فالرقم واحد لنفس الطالب والمهمة أينما ظهر."],
